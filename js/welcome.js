 ...
 * @FilePath: \hexo-anzhiyu博客源码d:\黄轩宇\hexo-anzhiyu博客\source\js\welcome.js
...
function showWelcome() {
    ...
    try {
        ...
        document.getElementById("welcome-info").innerHTML =
            `欢迎来自<br><span style="font-size: 12px;"><b><span style="color: var(--kouseki-ip-color);font-size: var(--kouseki-gl-size);">${pos}</span></b> 的小友💖</span><br><span style="font-size: 12px;">当前位置距博主约 <b><span style="color: var(--kouseki-ip-color);">${dist}</span></b> 公里！<br>您的IP地址为: <b><span>${ip}</span></b><br>${timeChange} <br></span>`;
